<div class="ml-2" style="width: 98%; font-size: 14px;">
    ...
    <a href="index.php?controllers=User&action=create" class="btn btn-primary mb-2" style="background-color: #4e7197; font-size: 12px;"> Add User</a>
    <table id="content-table" class="table table-bordered">
        ...
        ?>
            <tr>
                ...
                <td class="text-center"><a href="index.php?controllers=User&&action=showUpdate&&id=<?php echo $user['id']; ?>" class="btn btn-info btn-sm mr-1">Edit</a></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
